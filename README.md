...
```sh
  git clone https://github.com/calebchris000/Bookstore.git && cd Bookstore
```
...
The project has been deployed with Github pages. You can visit the link [here](https://calebchris000.github.io/Bookstore/build)
